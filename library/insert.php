...
$array_post = array('username','email','address','phone','gender','country');
...
if(isPost()){
    ...
    $error['country'] = validateMessages('country','Vui lòng chọn quốc gia');
...
<form action="" method="post">
    ...
    <div class="form-gr">
        ...
        <select name="country">
            ...
            <option value="Việt Nam" <?php if(isPost()) setBox("country",'Việt Nam');else if ($param['country'] == 'Việt Nam') echo 'selected';?>>Việt Nam</option>
        </select>
        &nbsp; &nbsp;
        <span class="error">
